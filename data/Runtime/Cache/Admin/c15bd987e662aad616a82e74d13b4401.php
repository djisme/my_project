...
<head>
	...
	<script>
		var URL = '/recruit/index.php/Admin/Help',
			SELF = '/recruit/index.php?m=Admin&amp;c=Help&amp;a=index',
...
<div class="seltpye_x">
    ...
    <div class="right">
        <a href="<?php echo P(array('parentid'=>'','type_id'=>''));?>" <?php if($_GET['parentid']== ''): ?>class="select"<?php endif; ?>>不限</a>
        <?php if(is_array($category[0])): $i = 0; $__LIST__ = $category[0];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$parent): $mod = ($i % 2 );++$i;?><a href="<?php echo P(array('parentid'=>$key,'type_id'=>''));?>" <?php if($_GET['parentid']== $key): ?>class="select"<?php endif; ?>><?php echo ($parent['categoryname']); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
        <div class="clear"></div>
    </div>
    <div class="clear"></div>
</div>
<?php if($_GET['parentid']!= ''): ?><div class="seltpye_x">
        ...
        <div class="right">
            ...
            <?php if(is_array($category[$parentid])): $i = 0; $__LIST__ = $category[$parentid];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sub): $mod = ($i % 2 );++$i;?><a href="<?php echo P(array('type_id'=>$key));?>" <?php if($_GET['type_id']== $key): ?>class="select"<?php endif; ?>><?php echo ($sub['categoryname']); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
            <div class="clear"></div>
        </div>
        <div class="clear"></div>
    </div><?php endif; ?>
    ...
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="list_tr link_black">
            <div class="td" style=" width:55%;">
                <div class="left_padding striking link_blue">
                    ...
                    <a href="<?php echo U('index',array('type_id'=>$vo['type_id'],'parentid'=>$vo['parentid']));?>" style="color: #006699">[<?php if($vo['category']['categoryname']): echo ($vo["category"]["categoryname"]); else: echo ($vo["parent"]["categoryname"]); endif; ?>]</a>
                    <?php echo ($vo["title"]); ?>
                </div>
            </div>
            <div class="td center" style=" width:10%;"><?php echo (($vo["ordid"] != "")?($vo["ordid"]):'0'); ?></div>
            <div class="td center" style=" width:10%;"><?php echo (($vo['click'] != "")?($vo['click']):'0'); ?></div>
