...
<head>
	...
	<script>
		var URL = '/recruit/index.php/Admin/Article',
			SELF = '/recruit/index.php?m=Admin&amp;c=Article&amp;a=index',
    ...
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="list_tr link_blue">
            <div class="td" style=" width:50%;">
                <div class="left_padding striking">
                    ...
                    <a href="<?php echo url_rewrite('QS_newsshow',array('id'=>$vo['id']));?>" target="_blank" style="<?php if($vo['tit_color']): ?>color:<?php echo ($vo["tit_color"]); ?>;<?php endif; if($vo['tit_b'] > 0): ?>font-weight:bold<?php endif; ?>"><?php echo ($vo["title"]); ?></a>
                    <?php if($vo['Small_img']): ?><span class="pictip vtip" title="">&nbsp;&nbsp;&nbsp;&nbsp;</span><?php endif; ?>
