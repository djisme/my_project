...
<head>
	...
	<script>
		var URL = '/recruit/index.php/Admin/CompanyImg',
			SELF = '/recruit/index.php?m=Admin&amp;c=CompanyImg&amp;a=index',
...
<div class="seltpye_x">
    ...
    <div class="right">
        ...
        <a href="<?php echo P(array('audit'=>'2'));?>" <?php if(($_GET['audit']) == "2"): ?>class="select"<?php endif; ?>>等待审核<?php if($count): ?><span>(<?php echo ($count); ?>)</span><?php endif; ?></a>
    ...
    <div class="imglist">
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="li">
                ...
                <div class="imgfoot link_w">
                    ...
                    <div class="manager"><a href="javascript:void(0);" class="userinfo" parameter="uid=<?php echo ($vo['uid']); ?>" hideFocus="true">管理</a></div>
