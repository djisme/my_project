...
<head>
	...
	<script>
		var URL = '/recruit/index.php/Admin/Report',
			SELF = '/recruit/index.php?m=Admin&amp;c=Report&amp;a=index',
...
<form id="form1" name="form1" method="post" action="<?php echo U('report_audit');?>">
    ...
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="list_tr link_blue">
            ...
            <div class="td" style=" width:20%;"><?php echo (($type_arr[$vo['report_type']] != "")?($type_arr[$vo['report_type']]):'-'); ?></div>
            <div class="td vtip" style=" width:30%;" title="<?php echo (nl2br($vo["content"])); ?>"><?php echo (($vo["content"] != "")?($vo["content"]):'-'); ?></div>
