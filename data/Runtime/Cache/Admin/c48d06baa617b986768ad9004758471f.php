...
<head>
	...
	<script>
		var URL = '/recruit/index.php/Admin/Ad',
			SELF = '/recruit/index.php?m=Admin&amp;c=Ad&amp;a=index',
    ...
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="list_tr link_blue">
            <div class="td" style=" width:32%;">
                <div class="left_padding striking">
                    ...
                    <a href="<?php echo U('edit',array('id'=>$vo['id']));?>" <?php if($vo['text_color']): ?>style="color:<?php echo ($vo["text_color"]); endif; ?> <?php if($vo['type_id'] == 1): ?>class="vtip" title="<?php echo ($vo["content"]); ?>"<?php endif; ?> <?php if($vo['type_id'] == 2): ?>class="vtip" title='<img src="<?php echo attach($vo['content'],'ads');?>"/>'<?php endif; ?>><?php echo ($vo["title"]); ?></a>
