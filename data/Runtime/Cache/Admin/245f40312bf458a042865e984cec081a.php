...
<head>
	...
	<script>
		var URL = '/recruit/index.php/Admin/Explain',
			SELF = '/recruit/index.php?m=Admin&amp;c=Explain&amp;a=index',
    ...
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="list_tr link_black">
            <div class="td" style=" width:40%;">
                <div class="left_padding striking link_blue">
                    ...
                    <a href="<?php echo url_rewrite('QS_explainshow',array('id'=>$vo['id']));?>" target="_blank" style="<?php if($vo['tit_color']): ?>color:<?php echo ($vo["tit_color"]); ?>;<?php endif; if($vo['tit_b'] > 0): ?>font-weight:bold<?php endif; ?>"><?php echo ($vo["title"]); ?></a>
            ...
            <div class="td center" style=" width:10%;"><?php echo (($vo["show_order"] != "")?($vo["show_order"]):'-'); ?></div>
...
<div class="list_foot">
    <div class="btnbox">
        <input type="button" class="admin_submit" id="ButAdd" value="添加说明页" onclick="window.location='<?php echo U('add');?>'"/>
